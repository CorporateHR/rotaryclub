...
import { FiPhone, FiMail, FiMessageCircle, FiArrowLeft } from 'react-icons/fi';
  ...
  if (!member) {
    return (
      <div>
        ...
        <div className={styles.container}><p>Member not found</p></div>
      </div>
    );
  }
  ...
  return (
    <div className={styles.detailPage}>
      ...
      <div className={styles.container}>
        <button className={styles.backButton} onClick={() => navigate('/admin/members')}>
        ...
        <Card className={styles.statsCard}>
          ...
          <div className={styles.stats}>
            ...
            {member.role && ['president', 'secretary', 'treasurer'].includes(member.role) && (
              <div className={styles.statItem}>
                <span className={styles.statLabel}>Board Role</span>
                <span className={styles.statValue}>{getRoleLabel(member.role)}</span>
              </div>
            )}
          </div>
        </Card>
        ...
        <div className={styles.actions}>
          ...
          <Button variant="secondary" onClick={() => window.location.href = `mailto:${member.email}`}>
            <FiMail /> Email
          </Button>
        </div>
      </div>
